    ...
    function populateTable(data) {
        ...
        data.forEach((item, index) => {
            recordTable.row.add([
                ...
                item.certificate ? 
                `<a href="dist/img/award/${item.certificate}" target="_blank" class="block w-16 mx-auto rounded-lg overflow-hidden border border-gray-100 opacity-80 hover:opacity-100 transition-all">
                    <img src="dist/img/award/${item.certificate}" class="w-full h-10 object-cover">
                </a>` : 
...
<style>
@media print {
    #sidebar, nav, #filterBtn, select, .dataTables_paginate { display: none !important; }
