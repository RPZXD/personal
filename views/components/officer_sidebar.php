...
// Menu configuration for Officer Portal
$menuItems = [
    [
        'key' => 'dashboard',
        'name' => 'หน้าหลัก',
    ...
    <div class="h-full overflow-y-auto bg-gradient-to-b from-slate-900 via-slate-950 to-black">
            ...
            <div class="flex items-center justify-between">
                <a href="../index.php" class="flex items-center space-x-4 group flex-1">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] font-bold text-primary-400 tracking-[0.2em] uppercase">Officer Portal</p>
                    </div>
                </a>
        ...
        <div class="px-4 py-6">
            <div class="p-4 rounded-3xl bg-white/5 border border-white/5 backdrop-blur-sm">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="min-w-0">
                        <p class="text-sm font-bold text-white truncate"><?php echo $userData['Teach_name'] ?? 'Officer'; ?></p>
                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mt-1">
                            <i class="fas fa-user-shield mr-1"></i> OFFICER
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black to-transparent">
            <div class="text-center">
                ...
                <p class="text-[8px] text-gray-700 mt-1 font-bold italic opacity-50 uppercase tracking-tighter">Officer System v2.0</p>
            </div>
        </div>
    </div>
</aside>
