...
// Menu configuration for Teacher Portal
$menuItems = [
    [
        'key' => 'dashboard',
        'name' => 'หน้าหลัก',
            ...
            <div class="flex items-center justify-between">
                <a href="../index.php" class="flex items-center space-x-4 group flex-1">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] font-bold text-primary-400 tracking-[0.2em] uppercase">Teacher Portal</p>
                    </div>
                </a>
        ...
        <div class="px-4 py-6">
            <div class="p-4 rounded-3xl bg-white/5 border border-white/5 backdrop-blur-sm">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="min-w-0">
                        <p class="text-sm font-bold text-white truncate"><?php echo $userData['Teach_name'] ?? 'Teacher'; ?></p>
                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-purple-500/10 text-purple-400 border border-purple-500/20 mt-1">
                            <i class="fas fa-user-graduate mr-1"></i> TEACHER
                        </span>
                    </div>
                </div>
            </div>
