        ...
        try {
            ...
            if ($person->isLeavePeriodOverlapping($data['tid'], $data['date_start'], $data['date_end'])) {
                ...
                if ($result) {
                    ...
                    // Fetch teacher data for Line Notify
                    $teacherData = $teacher->userData($data['tid']);
                    $statusText = '';
                    switch ($data['status']) {
                        case '1': $statusText = 'ลาป่วย'; break;
                        case '2': $statusText = 'ลากิจ'; break;
                        case '3': $statusText = 'ไปราชการ'; break;
                        case '4': $statusText = 'ลาคลอด'; break;
                        case '9': $statusText = $data['other_leave_type']; break;
                        default: $statusText = 'ไม่ระบุ'; break;
                    }
